                  ...
                  <div @click="redirectToLink(matiere.id)" class="card-content">
                    ...
                    <q-menu fit anchor="top right" self="bottom middle" v-model="showMenu[matiere.id]">
                      <q-list style="min-width: 100px">
                        <q-item clickable v-close-popup @click.stop="toggleCde({ matiereId: matiere.id, matiereName: matiere.nom, isCde: matiere.cde })">
...
export default {
  ...
  computed: {
    ...
    filteredMatieres() {
      ...
      const categories = ["Matériel & Articles de conditionnement"];
